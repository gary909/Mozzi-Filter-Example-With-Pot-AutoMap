...
#include <AutoMap.h> // track the pots
...
//int cutVal = 0; //a value to store cutoff freq amount ***get rid of this use automap***
AutoMap cutValMap(0, 1023, 0, 255);  // Maps our pot
...
//  lpf.setCutoffFreq(cutoff_freq);
    ...
    int cutVal = mozziAnalogRead(cutoffPot);
    cutVal = cutValMap(cutVal);
//    byte cutoff_freq = cutVal;
//    lpf.setCutoffFreq(cutoff_freq);
    lpf.setCutoffFreq(cutVal);
